...
// To work with Iff and Bool
#define NotHelpers_Zero PROBE()
...
#define AddHelpers_Add2(x,y) Glue(AddHelpers_,x), y)
...
#define MultiplyHelpers_Mult2(x,y,z) Glue(MultiplyHelpers_,x), y, z)
